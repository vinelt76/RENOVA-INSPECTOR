...
- **Fecha:** 2026-07-25
- **Estado:** Supersedida el 2026-09-26
...
> **Decisión vigente desde 2026-09-26:** la app móvil y los dashboards requieren inicio de sesión de usuario. La decisión de operar como `anon` y las recomendaciones de cuenta de dispositivo descritas abajo quedan obsoletas. Este documento conserva el diagnóstico histórico del 2026-07-25; el cierre técnico está propuesto en el PR de revisión y requiere validar/aplicar la migración antes de dar por retirado el acceso anónimo en producción.
