...
export function createSummaryConfirmUI({
  ...
  title.id = "movimientos-summary-title";
  ...
  function buildEditor(row) {
    ...
    editor.id = `movimientos-summary-editor-${index}`;
    ...
    const save = createElement(documentObject, "button", "btn-accion", "Guardar edición");
    save.type = "button";
  ...
  function buildMovementRow(row) {
    ...
    edit.setAttribute("aria-controls", `movimientos-summary-editor-${row.index}`);
