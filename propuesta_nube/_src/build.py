#!/usr/bin/env python3
"""Genera la propuesta corta (piloto en la nube).

Toma la plantilla de _src/, inyecta la hoja de estilo compartida y las fuentes
de marca como data URI, y escribe el HTML final en propuesta_nube/.

Uso:  python3 propuesta_nube/_src/build.py
"""
import base64
import pathlib
import re
...
DOCS = {
    "cliente.html": "Propuesta - Modulo Inspecciones RENOVA (Piloto).html",
}
