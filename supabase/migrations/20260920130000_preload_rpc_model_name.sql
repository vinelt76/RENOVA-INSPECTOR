-- Devuelve el modelo capturado en la inspección para que la app pueda
-- precargarlo en la siguiente inspección sin inferirlo por marca o medida.
...
comment on function public.get_unidad_preload(text, text) is
  'Precarga una unidad y conserva el model_name capturado en la última inspección. No infiere datos por marca o medida.';
