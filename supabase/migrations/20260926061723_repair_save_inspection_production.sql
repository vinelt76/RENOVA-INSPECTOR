-- RENOVA — repara el guardado de inspecciones tras el hardening móvil.
-- La migración 20260926060405 dejó temporalmente un sentinel de despliegue
-- en save_inspection. Esta migración restaura la implementación completa.
-- Mantiene el acceso exclusivamente para authenticated y perfil inspector.
